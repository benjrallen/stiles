...
//$script(Guru.TemplateUrl+'/js/modernizr.js', 'modernizr');
$script('//ajax.googleapis.com/ajax/libs/jquery/1.6.1/jquery.min.js', 'jquery');

//$script.ready( ['modernizr','jquery'], function(){
$script.ready( ['jquery'], function(){
    $script( Guru.TemplateUrl+'/js/plugins.js', 'plugins');
    $script.ready('plugins', function(){
        $script( Guru.TemplateUrl+'/js/common.js');
    });
});